...
- procedure hourly exposure flag 생성
- 결측 처리
...
- 이 노트북은 extraction만 수행합니다. Hourly timeseries와 assessment index 생성은 `2_data_transform.ipynb`, EDA는 `3_eda.ipynb`, train/test split과 모델링 입력 준비는 `4_modeling.ipynb`에서 처리합니다.
